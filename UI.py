...
class GameSettins(UI):
    ...
    def setup_widgets(self):
        ...
        slider_music = UISlider(width=400, height=50, min_value=0, max_value=100, value=70)
        ...
        text_general = UILabel(text="Общая громкость", font_size=30, align="center", width=400)
        slider_general = UISlider(width=400, height=50, min_value=0, max_value=100, value=100)
